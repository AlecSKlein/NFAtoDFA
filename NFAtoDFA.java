...
public class NFAtoDFA
{
	public class NFA
	{
		...
		public ArrayList<ArrayList<Integer> > allStates;
		...
		public NFA()
		{
			...
			allStates = new ArrayList<ArrayList<Integer> >();
			initState = 0;
			finalStates = new ArrayList<Integer>();
		}

		public NFA(int n, ArrayList<Character> sigma, ArrayList<ArrayList<Integer> > states, int initial, ArrayList<Integer> fStates)
		{
			numStates = n;
			for(char c: sigma)
				alphabet.add(c);
	...
	public NFA extractNFA(ArrayList<String> lines)
	{
		...
		*/
		...
		System.out.println("Remaining in list:");
		for(String s: lines)
			System.out.println(s);

		extractStates(n, lines);

		return nfa;
	}

	public void extractStates(int size, ArrayList<String> states)
	{
